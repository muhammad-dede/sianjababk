<form action="{{ route('analisa.bahan-kerja.update', $bahan_kerja->id) }}" class="modal-form" method="POST">
    @csrf
    @method('put')
    <div class="modal-header">
        <h5 class="modal-title">Edit Bahan Kerja</h5>
    ...
    <div class="modal-body">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="penggunaan_bahan_kerja" id="penggunaan_bahan_kerja"
                value="{{ $bahan_kerja->penggunaan_bahan_kerja }}">
        </div>
    </div>

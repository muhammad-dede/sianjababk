<form action="{{ route('jabatan.store') }}" class="modal-form" method="POST">
    @csrf
    ...
    <div class="modal-body">
        ...
        <div class="mb-3">
            <input type="hidden" class="form-control" name="induk_selected" id="induk_selected" value="">
            <label class="form-label" for="induk">Induk Jabatan</label>
            <select class="form-select" name="induk" id="induk"></select>

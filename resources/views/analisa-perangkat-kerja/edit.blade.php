<form action="{{ route('analisa.perangkat-kerja.update', $perangkat_kerja->id) }}" class="modal-form" method="POST">
    @csrf
    @method('put')
    <div class="modal-header">
        <h5 class="modal-title">Edit Perangkat Kerja</h5>
    ...
    <div class="modal-body">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="perangkat_kerja" id="perangkat_kerja"
                value="{{ $perangkat_kerja->perangkat_kerja }}">
        </div>
        <div class="mb-3">
            <label class="form-label required" for="penggunaan_perangkat_kerja">Penggunaan Dalam Tugas</label>
            <input type="text" class="form-control" name="penggunaan_perangkat_kerja" id="penggunaan_perangkat_kerja"
                value="{{ $perangkat_kerja->penggunaan_perangkat_kerja }}">
        </div>
    </div>

<form action="{{ route('analisa.prestasi-kerja.update', $prestasi_kerja->id) }}" class="modal-form" method="POST">
    @csrf
    @method('put')
    <div class="modal-header">
        <h5 class="modal-title">Edit Prestasi Kerja</h5>
    ...
    <div class="modal-body">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="hasil_prestasi_kerja" id="hasil_prestasi_kerja"
                value="{{ $prestasi_kerja->hasil_prestasi_kerja }}">
        </div>
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="jumlah_hasil_prestasi_kerja"
                id="jumlah_hasil_prestasi_kerja" value="{{ $prestasi_kerja->jumlah_hasil_prestasi_kerja }}">
        </div>
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="jam_prestasi_kerja" id="jam_prestasi_kerja"
                value="{{ $prestasi_kerja->jam_prestasi_kerja }}">
        </div>
    </div>

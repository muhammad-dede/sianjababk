<form action="{{ route('analisa.korelasi-jabatan.update', $korelasi_jabatan->id) }}" class="modal-form" method="POST">
    @csrf
    @method('put')
    <div class="modal-header">
        <h5 class="modal-title">Edit Korelasi Jabatan</h5>
    ...
    <div class="modal-body">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="nama_korelasi_jabatan" id="nama_korelasi_jabatan"
                value="{{ $korelasi_jabatan->nama_korelasi_jabatan }}">
        </div>
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="unit_kerja_korelasi_jabatan"
                id="unit_kerja_korelasi_jabatan" value="{{ $korelasi_jabatan->unit_kerja_korelasi_jabatan }}">
        </div>
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="dalam_hal" id="dalam_hal"
                value="{{ $korelasi_jabatan->dalam_hal }}">
        </div>
    </div>
